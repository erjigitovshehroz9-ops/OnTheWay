-- Auksion: server-side truth, row lock, RPC start/step + finalize expired.
-- Mavjud `auction_ends_at` bilan mos; `auction_expires_at` xuddi shu muddat (ikki ustun bir vaqtda yangilanadi).
...
BEGIN
  ...
  -- POSTED: birinchi kuryer auksionni boshlaydi
  ...
  -- AUCTION_LIVE: keyingi qabul / qadam
